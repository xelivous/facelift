                        ...
                        if (FR_CFG.getBool('FD_PostStats') ){
							...
							if (PostTable[x].Ratings) {
								PostTable[x].Ratings.forEach(function(rating) {
									if (rating.Name === "Agree")      { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingAgree)+"'>Rated Agree: "+rating.Count+" ("+postscore.RatingAgree+")</div>"; }
									if (rating.Name === "Funny")      { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingFunny)+"'>Rated Funny: "+rating.Count+" ("+postscore.RatingFunny+")</div>"; }
									...
									if (rating.Name === "Artistic")   { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingArtistic)+"'>Rated Artistic: "+rating.Count+" ("+postscore.RatingArtistic+")</div>"; }
									if (rating.Name === "Late")       { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingLate)+"'>Rated Late: "+rating.Count+" ("+postscore.RatingLate+")</div>"; }
									if (rating.Name === "BadSpell")   { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingBadSpell)+"'>Rated Bad Spelling: "+rating.Count+" ("+postscore.RatingBadSpell+")</div>"; }
									if (rating.Name === "BadRead")    { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingBadRead)+"'>Rated Bad Reading: "+rating.Count+" ("+postscore.RatingBadRead+")</div>"; }
									if (rating.Name === "Zing")       { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingZing)+"'>Rated Zing: "+rating.Count+" ("+postscore.RatingZing+")</div>"; }
									if (rating.Name === "OIFY")       { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingOIFY)+"'>Rated Pinknipple: "+rating.Count+" ("+postscore.RatingOIFY+")</div>"; }
									if (rating.Name === "ProgKing")   { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingProgKing)+"'>Rated Programming King: "+rating.Count+" ("+postscore.RatingProgKing+")</div>"; }
									if (rating.Name === "LuaKing")    { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingLuaKing)+"'>Rated Lua King: "+rating.Count+" ("+postscore.RatingLuaKing+")</div>"; }
									if (rating.Name === "LuaHelp")    { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingLuaHelp)+"'>Rated Lua Helper: "+rating.Count+" ("+postscore.RatingLuaHelp+")</div>"; }
									if (rating.Name === "MapKing")    { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingMapKing)+"'>Rated Mapping king: "+rating.Count+" ("+postscore.RatingMapKing+")</div>"; }
									if (rating.Name === "Smarked")    { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingSmarked)+"'>Rated Smarked: "+rating.Count+" ("+postscore.RatingSmarked+")</div>"; }
									if (rating.Name === "Moustache")  { crapmenu.innerHTML += "<div style='display: inline-block; float: none;' class='button "+FR_FUN.calcPolarity(postscore.RatingMoustache)+"'>Rated Moustache: "+rating.Count+" ("+postscore.RatingMoustache+")</div>"; }
								})
							}
